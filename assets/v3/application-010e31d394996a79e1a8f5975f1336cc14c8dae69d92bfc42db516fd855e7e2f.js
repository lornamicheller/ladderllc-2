...
function ParticleSlider(t) {
  ...
  wt.param = function (t, e) {
    ...
    serializeArray: function () {
      return this.map(function () {
        ...
        var t = this.type;
        return this.name && !wt(this).is(":disabled") && $e.test(this.nodeName) && !Ee.test(t) && (this.checked || !Kt.test(t))
      }).map(function (t, e) {
        var i = wt(this).val();
  ...
  wt.ajaxSetup({
    ...
    var s, o, r, a = !1 !== e.jsonp && (Ke.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ke.test(e.data) && "data");
    if (a || "jsonp" === e.dataTypes[0]) return s = e.jsonpCallback = _t(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ke, "$1" + s) : !1 !== e.jsonp && (e.url += (Me.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), e.converters["script json"] = function () {
    ...
    var n, s, o, r = this,
      a = t.indexOf(" ");
    return a > -1 && (n = G(t.slice(a)), t = t.slice(0, a)), _t(e) ? (i = e, e = void 0) : e && "object" == typeof e && (s = "POST"), r.length > 0 && wt.ajax({
      url: t,
      type: s || "GET",
      dataType: "html",
      data: e
  ...
  return wt.noConflict = function (e) {
    return t.$ === wt && (t.$ = Qe), e && t.jQuery === wt && (t.jQuery = Ge), wt
  }, e || (t.jQuery = t.$ = wt), wt
}),
    ...
    _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (t, e, i) {
        ...
        var c, u, d, p, f, m, g, v, _ = /(?:\-|\.|\b)(\d|\.|e\-)+/g,
          ...
          Q = function (t, e) {
            ...
            return n >= 0 ? (G = 3 === n ? "ms" : i[n], K = "-" + G.toLowerCase() + "-", G + t) : null
          },
        ...
        for (kt("clearProps", {
            parser: function (t, e, n, s, o) {
              return (o = new yt(t, n, 0, 0, o, 2)).setRatio = Kt, o.e = e, o.pr = -10, o.data = s._tween, i = !0, o
            }
...
psParticle.prototype.move = function () {
  ...
  function (t, e) {
    ...
    function t() {
      e(), AppYalantis.FormCheckbox.init(), AppYalantis.BackgroundAdapter.init(), AppYalantis.DeviceAdapter.init(), AppYalantis.ScrollCatch.init(), n(), s()
    }
      ...
      if (r.length) {
        ...
        if ("desktop" === AppYalantis.Helpers.getBrowserWidth()) {
          ...
          AppYalantis.Helpers.imageOnLoad(e, function () {
            ...
            a = new ParticleSlider(e), $(window).on("resize", function () {
    ...
    function o() {
      ...
      if (e) $("#subscription-checkbox-error").remove();
        ...
        var i = $('<div class="form-checkbox__msg"></div>').attr("id", "subscription-checkbox-error").text("Please, agree with our Privacy Policy");
        t.append(i)
      }
    }
    ...
    c.blur(function () {
      $(".remove-active").remove(), $(this).parent(c).removeClass("form-field--active"), 0 === $(this).val().length ? $(this).parent($(".form-field")).removeClass("form-field--filled") : $(this).parent($(".form-field")).addClass("form-field--filled")
    }), c.focus(function () {
    ...
    }, "Is too long (maximum is 256 characters)"), l.submit(function (t) {
      if (t.preventDefault(), o(), !($("#subscription-checkbox-error").length || $(".form-field--error").length)) {
        ...
        $.ajax({
          ...
          data: {
            privacy_policy_accepted: i,
            email: e
          },
          success: function (t) {
            t.success ? ($(".sender__subscribe").css("display", "none"), $("#subscribe-complete").css("display", "block"), setTimeout(function () {
              h.css("overflow", "auto"), $(".modal").removeClass("modal--open"), $(".sender__subscribe").css("display", "block"), $("#subscribe-complete").css("display", "none"), l.each(function () {
                this.reset()
              })
            }, 2e3)) : $(".form-field.form-field--filled").addClass("form-field--error").append('<div id="subscription[email]-error" class="form-field__msg remove-active" style="">' + t.errors.email + "</div>")
          },
          error: function (t) {
            console.log("error " + t)
          }
    ...
    }), $(".build-scheme__title, .build-scheme__block").mouseenter(function () {
    ...
    $(".section__heading, .recent-projects .project__desc, .concept__desc, .architect-scheme, .mails-list").each(function () {
      new ScrollMagic.Scene({
        triggerElement: this,
        triggerHook: .85
    ...
    $(".design-projects .section--project:nth-child(1)").each(function () {
      ...
      new ScrollMagic.Scene({
        ...
        opacity: 0,
        ease: t
      }, 0).from($(this).find(".dots"), .5, {
        xPercent: 50,
        opacity: 0,
        ease: t
      }, .5)).reverse(!1).addTo(i)
    }), $(".design-projects .section--project:nth-child(3)").each(function () {
      new ScrollMagic.Scene({
        triggerElement: this,
        triggerHook: "onCenter"
      }).setTween((new TimelineMax).from($(this).find(".project__img-wrap"), .5, {
        ...
        opacity: 0,
        ease: t
      }, 0)).setClassToggle(".design-projects .section--project:nth-child(3) .balloons", "animated").reverse(!1).addTo(i)
    });
    new ScrollMagic.Scene({
    ...
    function d() {
      return {
        ...
        anniversary: "linear-gradient(to left, rgba(24, 24, 34, 1), rgba(24, 24, 34, 1))",
        ...
        "connect-home": "linear-gradient(to left, rgba(22, 24, 28, 1), rgba(22, 24, 28, 1))",
        ...
        "fitness-center-platform": "linear-gradient(to left, rgba(34, 192, 201, 1), rgba(55, 192, 182, 1))",
        ...
        "on-demand": "linear-gradient(to left, rgba(52, 159, 255, 1), rgba(52, 186, 254, 1))",
